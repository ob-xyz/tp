...
function ko(e) {
  ...
  re = /** @type {null | Value[]} */
  null, ce = 0, he = null, Ve = (d & fe) !== 0 && (ke || !nt || $ === null), $ = (d & (De | it)) === 0 ? e : null, Te = null, Vn(e.ctx), ke = false, ur++, e.f |= Sr;
  try {
    var m = (
      /** @type {Function} */
      (0, e.fn)()
    ...
    if (re !== null) {
      ...
      v !== null && ce < v.length && (cr(e, ce), v.length = ce);
...
function be(e, t) {
  ...
  return () => {
    ...
    var s = (
      /** @type {TemplateNode} */
      o || no ? document.importNode(l, true) : l.cloneNode(true)
    );
    if (r) {
      var c = (
        /** @type {TemplateNode} */
...
function Oo(e, { target: t, anchor: r, props: o = {}, events: l, context: a, intro: s = true }) {
  Tr();
...
function K(e, t, [r, o] = [0, 0]) {
  O && r === 0 && Et();
  var l = e, a = null, s = null, c = ae, f = r > 0 ? Ur : 0, d = false;
  const m = (_, w = true) => {
    d = true, v(w, _);
  }, v = (_, w) => {
    if (c === (c = _))
    ...
    if (O && o !== -1) {
      ...
      const M = o > r;
      !!c === M && (l = aa(), Ue(l), _t(false), F = true, o = -1);
    }
  ...
  fo(() => {
    d = false, t(m), d || v(null, null);
  }, f), O && (l = P);
}
function tt(e, t, r = false, o = false, l = false) {
  var a = e, s = "";
  Ce(() => {
    var c = (
      /** @type {Effect} */
...
function x(e, t, r, o) {
  var l = (r & Pi) !== 0, a = true, s = (r & Fi) !== 0, c = (r & Mi) !== 0, f = false, d;
  s ? [d, f] = za(() => (
    /** @type {V} */
    e[t]
  )) : d = /** @type {V} */
  ...
  var m = Ot in e || ro in e, v = s && (rt(e, t)?.set ?? (m && t in e && ((j) => e[t] = j))) || void 0, _ = (
    /** @type {V} */
    o
  ), w = true, F = false, M = () => (F = true, w && (w = false, c ? _ = ot(
    /** @type {() => V} */
    o
  ) : _ = /** @type {V} */
  o), _);
  ...
  if (U = () => {
    ...
    return j === void 0 ? M() : (w = true, F = false, j);
  }, (r & Oi) === 0)
    return U;
  if (v) {
    var I = e.$$legacy;
  ...
  var ee = false, $e = /* @__PURE__ */ Yr(d), X = /* @__PURE__ */ gr(() => {
    var j = U(), se = i($e);
    return ee ? (ee = false, se) : $e.v = j;
  });
  return s && i(X), l || (X.equals = jr), function(j, se) {
    if (arguments.length > 0) {
      const He = se ? i(X) : s ? Me(j) : j;
      if (!X.equals(He)) {
        if (ee = true, b($e, He), F && _ !== void 0 && (_ = He), Gn(X))
          return j;
        ot(() => i(X));
      }
      return j;
...
var Ka = class {
  ...
  constructor(t) {
    ...
    this.#e = (t.hydrate ? Pa : Po)(t.component, {
      ...
      intro: t.intro ?? false,
      recover: t.recover
    }), (!t?.props?.$$host || t.sync === false) && E(), this.#t = l.$$events;
...
function ul(e, t, r, o, l, a, s, c) {
  [
    ...
    y.EXPIRED,
    y.CODE
  ].includes(i(t)) ? r() !== false && i(o)?.reportValidity() === false ? b(l, false) : a() ? s() : c() : b(l, true);
}
...
function kl(e, t) {
  ...
  let a = x(t, "auto", 7, void 0), s = x(t, "blockspam", 7, void 0), c = x(t, "challengeurl", 7, void 0), f = x(t, "challengejson", 7, void 0), d = x(t, "credentials", 7, void 0), m = x(t, "customfetch", 7, void 0), v = x(t, "debug", 7, false), _ = x(t, "delay", 7, 0), w = x(t, "disableautofocus", 7, false), F = x(t, "refetchonexpire", 7, true), M = x(t, "disablerefetchonexpire", 23, () => !F()), U = x(t, "expire", 7, void 0), I = x(t, "floating", 7, void 0), ee = x(t, "floatinganchor", 7, void 0), $e = x(t, "floatingoffset", 7, void 0), X = x(t, "floatingpersist", 7, false), j = x(t, "hidefooter", 7, false), se = x(t, "hidelogo", 7, false), He = x(t, "id", 7, void 0), Ht = x(t, "language", 7, void 0), Ge = x(t, "name", 7, "altcha"), We = x(t, "maxnumber", 7, 1e6), xt = x(t, "mockerror", 7, false), Ne = x(t, "obfuscated", 7, void 0), ge = x(t, "overlay", 7, void 0), Ct = x(t, "overlaycontent", 7, void 0), Gt = x(t, "plugins", 7, void 0), Ye = x(t, "sentinel", 7, void 0), ye = x(t, "spamfilter", 7, false), st = x(t, "strings", 7, void 0), de = x(t, "test", 7, false), te = x(t, "verifyurl", 7, void 0), ut = x(t, "workers", 23, () => Math.min(16, navigator.hardwareConcurrency || 8)), kt = x(t, "workerurl", 7, void 0);
  ...
  Dr(() => {
    ...
    A("mounted", "2.2.4"), A("workers", ut()), Qo(), A("plugins", Oe.length ? Oe.map((n) => n.constructor.pluginName).join(", ") : "none"), de() && A("using test mode"), U() && xr(U()), a() !== void 0 && A("auto", a()), I() !== void 0 && gn(I()), b(T, i(V)?.closest("form"), true), i(T) && (i(T).addEventListener("submit", an, { capture: true }), i(T).addEventListener("reset", ln), (a() === "onfocus" || X() === "focus") && i(T).addEventListener("focusin", on)), ge() && pn(true), a() === "onload" && (Ne() ? $t() : Se()), i(br) && (j() || se()) && A("Attributes hidefooter and hidelogo ignored because usage with free API Keys requires attribution."), requestAnimationFrame(() => {
      Le("load");
    });
  });
  function Yt(n, u) {
  ...
  async function Jo() {
      ...
      return A("generating test challenge", { test: de() }), tl(typeof de() != "boolean" ? +de() : void 0);
    {
      ...
      const n = {
        ...
        headers: ye() !== false ? { "x-altcha-spam-filter": "1" } : {}
      }, u = await Er()(c(), n);
...
`) : C), h;
  ...
  function ai(n) {
    if (n.preventDefault(), n.stopPropagation(), i(G)) {
      ...
      b(Je, true), hn(Yt(i(G).challenge, i(G).solution), h).then(({ reason: p, verified: g }) => {
        g ? (b(G, null), xe(y.VERIFIED), A("verified"), Rr().then(() => {
          i(yr)?.focus(), Le("verified", { payload: i(Ee) }), a() === "onsubmit" ? vn(i(Rt)) : ge() && St();
        })) : (Ke(), b(ze, p || "Verification failed", true));
      }).catch((p) => {
  ...
  function rn(n) {
    const u = n.target;
    I() && u && !i(V).contains(u) && (i(k) === y.VERIFIED && X() === false || i(k) === y.VERIFIED && X() === "focus" && !i(T)?.matches(":focus-within") || a() === "off" && i(k) === y.UNVERIFIED) && St();
  }
  function nn() {
  ...
  function an(n) {
    n.target?.hasAttribute("data-code-challenge-form") || (b(Rt, n.submitter, true), i(T) && a() === "onsubmit" ? (i(Rt)?.blur(), i(k) === y.UNVERIFIED ? (n.preventDefault(), n.stopPropagation(), Se().then(() => {
      vn(i(Rt));
  ...
  async function ui(n) {
    ...
    if (ye() !== false) {
      ...
      u.blockedCountries = g, u.classifier = C, u.disableRules = D, u.email = H === false ? void 0 : Ko(H), u.expectedCountries = oe, u.expectedLanguages = q || (Jr ? [Jr] : void 0), u.fields = ie === false ? void 0 : en(ie), u.ipAddress = Qe === false ? void 0 : Qe || "auto", u.text = dt, u.timeZone = et === false ? void 0 : et || Wn();
    }
    const h = await Er()(te(), {
    ...
    if (p?.payload && b(Ee, p.payload, true), Le("serververification", p), s() && p.classification === "BAD")
  ...
  async function hn(n, u) {
    ...
    return g?.payload && b(Ee, g.payload, true), Le("sentinelverification", g), g;
  }
  function vn(n) {
  ...
  function gn(n) {
    A("floating", n), I() !== n && (i(V).style.left = "", i(V).style.top = ""), I(n === true || n === "" ? "auto" : n === false || n === "false" ? void 0 : I()), I() ? (a() || a("onsubmit"), document.addEventListener("scroll", nn), document.addEventListener("click", rn), window.addEventListener("resize", cn)) : a() === "onsubmit" && a(void 0);
  }
  function pn(n) {
    if (A("overlay", n), ge(n), n) {
      if (a() || a("onsubmit"), i(ue) && i(V).parentElement && i(ue).replaceWith(i(V).parentElement), i(V)?.parentElement?.parentElement) {
        b(ue, document.createElement("div"), true), i(V).parentElement.parentElement.appendChild(i(ue));
      ...
      i(ue) && i(V).parentElement && (i(ue).replaceWith(i(V).parentElement), i(V).style.display = "block");
  }
  function mn(n) {
    if (!n.algorithm)
  ...
  async function _n(n) {
    ...
    if ("Worker" in window) {
      try {
        u = ci(n, n.maxNumber || n.maxnumber || We()), b(Ze, u.controller, true), h = await u.promise;
      } catch (p) {
        A(p);
      } finally {
        b(Ze, null);
    ...
    u = rl(n.challenge, n.salt, n.algorithm, n.maxNumber || n.maxnumber || We()), b(Ze, u.controller, true);
    try {
      h = await u.promise;
    } catch (p) {
      A(p);
  ...
  function Tt(n = 20) {
    if (i(V))
      if (i(ct) || b(ct, (ee() ? document.querySelector(ee()) : i(T)?.querySelector('input[type="submit"], button[type="submit"], button:not([type="button"]):not([type="reset"])')) || i(T), true), i(ct)) {
  ...
  function Ke(n = y.UNVERIFIED, u = null) {
    i(Ze) && (i(Ze).abort(), b(Ze, null)), b(At, false), b(Ee, null), b(G, null), b(wr, false), b(W, null), xe(n, u);
  }
  function xn(n) {
    b(ct, n, true);
  }
  function xe(n, u = null) {
    b(k, n, true), b(ze, u, true), Le("statechange", {
      payload: i(Ee),
      state: i(k)
    });
  }
      ...
      if (A("solution", u), !u || n && "challenge" in n && !("clearText" in u)) {
        if (u?.number !== void 0 && "challenge" in n)
          if (te() && "codeChallenge" in n)
            ["INPUT", "BUTTON", "SELECT", "TEXTAREA"].includes(document.activeElement?.tagName || "") && w() === false && document.activeElement.blur(), b(G, { challenge: n, solution: u }, true);
          else {
            if (te() && Ye() !== void 0)
              return hn(Yt(n, u));
            if (te())
              return ui(Yt(n, u));
            b(Ee, Yt(n, u), true), A("payload", i(Ee));
          }
  ...
  var Jt = J(zt, 2), hi = z(Jt);
  {
    ...
    K(hi, (n) => {
      i(k) === y.VERIFIED ? n(vi) : n(gi, false);
    });
  }
  Z(Jt);
  var Rn = J(Jt, 2);
      ...
      var C = J(g, 2), D = z(C), H = z(D);
      {
        var q = (pe) => {
          ...
          var Kt = z(Y);
          {
                ...
                var $i = (vt) => {
                ...
                }, Si = (vt, kr) => {
                  {
                    ...
                    K(
                      vt,
                      (gt) => {
                        i(W) === Q.PLAYING ? gt(Ti) : gt(Di, false);
                      },
                      kr
                    );
                  }
            ...
            K(Kt, (ht) => {
              i(W) === Q.LOADING ? ht(Dt) : ht(Ii, false);
            });
          }
          Z(Y), Ce(() => {
...
//# sourceMappingURL=/build/_shared/altcha-3KHXF6YF.js.map
