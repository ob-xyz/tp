  ...
  return (
    <div className="container">
      <div className="header">
       ...
       <h2 style={{ fontSize: 18, textAlign: "left" }}><br />Expect our fast feed in your inbox every day. It stitches together the best business-minded news, posts, and snarky comments from across the web. You can check out the latest issue <Link to='/live'>here →</Link></h2>
