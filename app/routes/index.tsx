  ...
  return (
    <div className="container">
      ...
      {showModal && (
        <div className="modal-overlay" onClick={() => setShowModal(false)}>
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            ...
            <p>Start your day with an unfair advantage. Get technology's biggest stories and posts delivered to your inbox every day.</p>
      ...
      <div className="header">
        ...
        <h2>Every morning 40,000+ execs and builders scroll <a href="/today">The Poast</a> for one minute of wickedly random stories and posts from across the web. Plus, the best tools, links, and ideas. Bit snarky. Real signal. Some bite.</h2>  
