  ...
  return (
    <div className="container">
      ...
      <div className="header">
        ...
        <h2>Every morning 40,000+ execs and builders scroll <a href="/today">The Poast</a> for technology's biggest stories and posts. Plus, the best AI tools, links, and ideas across the web. Bit snarky. All signal.</h2>  
