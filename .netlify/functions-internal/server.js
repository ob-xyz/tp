...
function Index4() {
  ...
  return (0, import_react10.useEffect)(() => {
    ...
    return observer.observe(headerImg), () => {
      observer.disconnect();
    };
